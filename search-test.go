...
func main() {
	...
	stwid1, err1 := v.StringToWordID(query[0])
	fmt.Println(stwid1)
	fmt.Println(err1)
	fmt.Println("\n--------------------")
	stwid2, err2 := v.StringToWordID(query[1])
	fmt.Println(stwid2)
	fmt.Println(err2)
	fmt.Println("\n--------------------")
	...
	fmt.Println("-------------------------")
	idf1, err3 := v.InverseDocumentFreq(query[0])
	fmt.Println(idf1)
	fmt.Println(err3)
	fmt.Println("\n-------------------------")
	idf2, err4 := v.InverseDocumentFreq(query[1])
	fmt.Println(idf2)
	fmt.Println(err4)
	fmt.Println("\n-------------------------")
	...
	fmt.Println("--------------")
	tf1, err5 := v.TermFreq(query[0], 0)
	fmt.Println(tf1)
	fmt.Println(err5)
	fmt.Println("\n--------------")
	tf2, err6 := v.TermFreq(query[1], 0)
	fmt.Println(tf2)
	fmt.Println(err6)
	fmt.Println("\n--------------")
	...
	fmt.Println("-----------------------")
	ctw1 := v.ComputeTermWeight(query[0], 0)
	fmt.Println(ctw1)
	//fmt.Println(err7)
	fmt.Println("\n-----------------------")
	ctw2 := v.ComputeTermWeight(query[1], 0)
	fmt.Println(ctw2)
	//fmt.Println(err8)
	fmt.Println("\n-----------------------")
	...
	fmt.Println("-----------------")
	mtf1 := v.MaxTermFreq(0)
	fmt.Println(mtf1)
	fmt.Println("\n-----------------")
	mtf2 := v.MaxTermFreq(1)
	fmt.Println(mtf2)
	fmt.Println("\n-----------------")
	...
	fmt.Println("-------------------")
	coss1 := v.CosSimilarity("paragraph document", 0)
	fmt.Println(coss1)
	//fmt.Println(err7)
	fmt.Println("\n-------------------")
	coss2 := v.ComputeTermWeight("paragraph document", 1)
	fmt.Println(coss2)
	//fmt.Println(err8)
	fmt.Println("\n-------------------")
